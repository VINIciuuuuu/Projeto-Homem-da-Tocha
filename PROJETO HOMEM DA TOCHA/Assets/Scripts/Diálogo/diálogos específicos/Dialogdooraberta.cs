...
public class Dialogdooraberta : MonoBehaviour
{
    ...
    public InternalIventory SriptInvIntdoor;
    ...
    private void Start()
    {
        ...
        SriptInvIntdoor = FindAnyObjectByType<InternalIventory>();
    ...
    private void GlobalDialogueEnded()
    {
        ...
        SriptInvIntdoor.IntChaveportapaispegou();
    }
